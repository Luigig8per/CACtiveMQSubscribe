...
namespace CACtiveMQSubscribe
{
    ...
    public partial class DonBestEntities : DbContext
    {
        ...
        public virtual ObjectResult<line> getAllLines()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<line>("getAllLines");
        }
    
        public virtual ObjectResult<line> getAllLines(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<line>("getAllLines", mergeOption);
        }
